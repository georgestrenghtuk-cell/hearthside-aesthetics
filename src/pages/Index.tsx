    ...
    <Layout>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-10">
            Van premium tot voordelig — voor elke kachel de juiste pellet.
          </p>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-warm-cream mb-10">
            Wat Klanten Zeggen
          </h2>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-xl mx-auto mb-10 text-lg">
            Bestel vandaag nog en geniet van snelle levering en betaling na ontvangst.
          </p>
          <a
            href="https://www.veluwsepellets.nl"
            target="_blank"
